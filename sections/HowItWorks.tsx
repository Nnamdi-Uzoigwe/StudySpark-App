...
export default function HowItWorks() {
    return (
        <div className="px-6 lg:px-50 py-10 text-white">
            <h1 className="text-gray-400 text-3xl font-semibold">How It Works in 3 Simple Steps</h1>

            <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-4">

                <div className="bg-[#393e3e] rounded-lg p-4">
                    <div className="flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-3 mb-2">
